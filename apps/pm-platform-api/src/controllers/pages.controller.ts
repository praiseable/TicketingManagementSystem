...
export const pagesController = {
  ...
  remove: asyncHandler(async (req, res) => {
    await pageService.assertSpaceMember(req.params.spaceId, req.user!.id, ['OWNER', 'EDITOR'] as any);
  ...
  shared: asyncHandler(async (req, res) => {
    const page = await prisma.page.findFirst({ where: { id: req.params.token, isArchived: false } });
