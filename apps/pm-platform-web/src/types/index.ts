...
export interface Project { id: ID; orgId: ID; name: string; key: string; description?: string | null; iconUrl?: string | null; workflows?: Workflow[]; _count?: { issues: number; members: number } }
